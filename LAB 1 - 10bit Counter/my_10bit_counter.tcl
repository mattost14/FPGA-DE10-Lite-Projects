...
# File: my_10bit_counter.tcl
# Generated on: Fri Sep 15 14:07:54 2023
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "my_10bit_counter"]} {
		puts "Project my_10bit_counter is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists my_10bit_counter]} {
		project_open -revision my_10bit_counter_top my_10bit_counter
	} else {
		project_new -revision my_10bit_counter_top my_10bit_counter
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "10:22:15  SEPTEMBER 15, 2023"
	...
	set_global_assignment -name VHDL_FILE my_10bit_counter_top.vhd
	set_global_assignment -name VHDL_FILE my_counter.vhd
	...
	set_global_assignment -name PARTITION_NETLIST_TYPE SOURCE -entity DE10_LITE_10BIT_COUNTER -section_id Top
	set_global_assignment -name PARTITION_FITTER_PRESERVATION_LEVEL PLACEMENT_AND_ROUTING -entity DE10_LITE_10BIT_COUNTER -section_id Top
	set_global_assignment -name PARTITION_COLOR 16764057 -entity DE10_LITE_10BIT_COUNTER -section_id Top
	set_global_assignment -name PARTITION_NETLIST_TYPE SOURCE -entity proj0_top -section_id Top
	set_global_assignment -name PARTITION_FITTER_PRESERVATION_LEVEL PLACEMENT_AND_ROUTING -entity proj0_top -section_id Top
	set_global_assignment -name PARTITION_COLOR 16764057 -entity proj0_top -section_id Top
	...
	set_instance_assignment -name PARTITION_HIERARCHY root_partition -to | -entity proj0_top -section_id Top
	set_instance_assignment -name PARTITION_HIERARCHY root_partition -to | -entity DE10_LITE_10BIT_COUNTER -section_id Top
